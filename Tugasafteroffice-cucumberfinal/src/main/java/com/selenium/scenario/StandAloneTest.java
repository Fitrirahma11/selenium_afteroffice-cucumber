...
public class StandAloneTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Isi Form Checkout
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("first-name"))).sendKeys("Rahmawati");
        driver.findElement(By.id("last-name")).sendKeys("Fitriah");
        driver.findElement(By.id("postal-code")).sendKeys("13610");
        Thread.sleep(600);
